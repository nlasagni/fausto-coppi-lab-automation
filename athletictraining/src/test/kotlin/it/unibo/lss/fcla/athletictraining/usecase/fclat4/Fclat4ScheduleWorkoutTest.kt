...
import it.unibo.lss.fcla.athletictraining.usecase.DummyScheduleWorkoutPresenter
import java.time.LocalDate
import java.time.LocalTime

/**
 * Test of the [Fclat4ScheduleWorkout] use case.
 *
 * @author Nicola Lasagni on 11/04/2021.
 */
class Fclat4ScheduleWorkoutTest : FreeSpec({
    ...
    val useCase = Fclat4ScheduleWorkout(
        DummyScheduleWorkoutPresenter(),
        gymOpenChecker,
    ...
    "The use case FCLAT-4 should" - {
        "allow the scheduling of a workout" - {
            ...
            val request = ScheduleWorkoutRequest(
                activeAthleticTrainingId.value,
                workoutId.value,
                beginning.plusDays(1),
                LocalTime.of(10, 0)
            )
